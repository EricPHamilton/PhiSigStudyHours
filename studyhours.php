			...
			<div class="row">
				...
				<form role="hoursForm" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>" method="post" name="submit_hours">
					<div class="col-lg-6">
						...
						<div class="form-group">
							<label for="InputMessage">What will you be working on? (Be Specific)</label>
							<div class="input-group">
							<textarea name="input_message" id="InputMessage" class="form-control" rows="5" required></textarea>
							<span class="input-group-addon"><i class="glyphicon glyphicon-ok form-control-feedback"></i></span></div>
						</div>
						<input type="submit" name="end" id="submitHours" value="Submit Hours" class="btn btn-info pull-right" onclick="turnOffDialog()">
						<input type="start" name="start" id="start" value="Start Studying" class="btn btn-info pull-left" onclick="startStudying()">
					</div>
				</form>
